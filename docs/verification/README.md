...
- Repository Evidence：初始 21 个文件、26 个 visible tests、10+ distinct files read、5+ existing production files changed、至少 1 个新文件；`incident/report.py` 初始不存在并必须由 Agent 创建。
